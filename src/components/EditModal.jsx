...
const EditModal = ({ day, mealType, onClose, editMeal, meal: { name, calories, index } }) => {
    ...
    const handleSubmit = () => {
        ...
        editMeal(day, mealType, index, {name: mealName, calories: parseInt(mealCalories)});
        onClose();
    }
    ...
    return (
        <div className='fixed inset-0 flex justify-center items-center bg-black/50'>
            <div className='relative flex flex-col justify-center items-center gap-5 bg-slate-950 text-gray-200 rounded-xl px-5 py-10 min-w-[85%]'>
                ...
                <h2 className='text-center text-xl font-bold mb-3'>Edytuj posiłek</h2>
                <input
                    type='text'
                    value={mealName}
